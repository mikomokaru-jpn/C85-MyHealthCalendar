...
static NSString* const DB_URL_READ1 = @"http://192.168.11.3/doc_health_calendar/php/sql_r10.php";
static NSString* const DB_URL_READ2 = @"http://192.168.11.3/doc_health_calendar/php/sql_r20.php";
static NSString* const DB_URL_WRITE1 = @"http://192.168.11.3/doc_health_calendar/php/sql_w10.php";
static NSString* const DB_URL_READ1_JSON = @"http://192.168.11.3/doc_health_calendar/php/sql_r10_json.php";
